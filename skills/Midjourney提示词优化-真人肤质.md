---
name: Midjourney提示词优化-真人肤质
description: Midjourney提示词优化的人脸肤质变体：人脸必须有真实皮肤纹理（毛孔、次表面散射等），脸部保持正常真人比例，不得二次元化、Q版化。当用户希望人物脸部真实、有皮肤质感、不要太卡通时使用。
---

# 〇、人脸肤质限定（本版本最高优先级，覆盖下方任何冲突规则）

1. **人脸必须有真实皮肤纹理（硬性）**：提示词中必须包含真实皮肤质感词汇，如 realistic skin texture、visible skin pores、natural skin imperfections、次表面散射 subsurface scattering，脸部要有真实纹理与毛孔细节，不要磨皮塑料感；
2. **脸部不得二次元/Q版化（硬性）**：脸型与五官保持正常真人比例——使用 realistic facial proportions、natural facial features，正常眼距、正常鼻唇位置、自然脸型；**禁止**大眼睛+小鼻子+尖下巴的二次元脸，禁止 chibi、Q版、幼态卡通脸表达；
3. **不强制摄影感**：不强制 photorealistic photography / 真人摄影表达，画面风格可保留用户要求的渲染风格（CGI / 插画 / 概念设计等均可），但脸部肤质与比例必须按第 1、2 条执行；
4. **自查（硬性）**：最终提示词中必须包含「真实皮肤纹理」与「正常脸部比例」词汇；任何二次元/Q版脸部词汇一律剔除或替换后再输出。
